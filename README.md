...
Interpretable Model Selection: Utilized a Logistic Regression Classifier to predict assistance needs (Voice vs. Standard). The choice of model prioritized interpretability which is essential for building trust and auditing algorithmic decisions in sensitive, user-facing applications.
